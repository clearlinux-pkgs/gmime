...
Requires: gmime = %{version}-%{release}
...
%prep
%setup -q -n gmime-3.2.7
cd %{_builddir}/gmime-3.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664146683
...
cp %{_builddir}/gmime-%{version}/COPYING %{buildroot}/usr/share/package-licenses/gmime/caeb68c46fa36651acf592771d09de7937926bb3 || :
%make_install
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/gmime/caeb68c46fa36651acf592771d09de7937926bb3
